...
/**
 * Validation middleware for creating a visit
 */
export const validateCreateVisit = [
  ...
  body('visitDate')
    .optional()
    .isISO8601().withMessage('Invalid visit date format'),
...
/**
 * Validation middleware for updating a visit
 */
export const validateUpdateVisit = [
  body('status')
    .optional()
    .isIn(Object.values(VisitStatus)).withMessage(`Status must be one of: ${Object.values(VisitStatus).join(', ')}`),
