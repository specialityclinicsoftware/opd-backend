...
app.get('/', (_req: Request, res: Response) => {
  res.json({
    ...
    endpoints: {
      ...
      workflow: {
        nurseQueue: 'GET /api/visits/queue/nurse',
        doctorQueue: 'GET /api/visits/queue/doctor',
        startPreConsultation: 'POST /api/visits/:id/start-pre-consultation',
        updatePreConsultation: 'PUT /api/visits/:id/pre-consultation',
        completePreConsultation: 'POST /api/visits/:id/complete-pre-consultation',
        startConsultation: 'POST /api/visits/:id/start-consultation',
        updateConsultation: 'PUT /api/visits/:id/consultation',
        finalizeVisit: 'POST /api/visits/:id/finalize',
      },
      visits: '/api/visits',
